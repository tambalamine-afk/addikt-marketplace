        ...
        <div className="flex items-center gap-2 md:gap-4 flex-1 lg:flex-none justify-end">
          ...
          {isLoggedIn && (
            <Link href="/messages" aria-label="Messages" className="hidden sm:flex text-primary hover:opacity-80 transition-opacity duration-200 items-center">
              <svg viewBox="0 0 133 114" className="w-[22px] h-auto fill-primary">
          ...
          <button aria-label="Favorites" className="hidden sm:flex text-primary hover:opacity-80 transition-opacity duration-200 items-center">
            <svg viewBox="0 0 126 114" className="w-[20.5px] h-auto fill-primary">
          ...
          <button aria-label="Shopping Bag" className="text-primary hover:opacity-80 transition-opacity duration-200 flex items-center">
            <svg viewBox="0 0 110 114" className="w-[18px] h-auto fill-primary">
