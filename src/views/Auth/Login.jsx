    ...
    <div className="bg-surface-container-lowest text-primary min-h-[calc(100vh-200px)] flex flex-col justify-center items-center p-grid-gutter antialiased w-full">
      <main className="w-full max-w-sm flex flex-col items-center">
        ...
        <form className="w-full space-y-6" onSubmit={handleLogin}>
          ...
          {/* Google Button */}
          <button type="button" onClick={handleGoogleSignIn} className="w-full bg-surface-container-lowest border-2 border-outline-variant text-primary font-button-text py-5 rounded-full flex items-center justify-center space-x-3 hover:bg-surface-container-low active:scale-95 transition-all duration-200 font-semibold whitespace-nowrap" style={{ fontFamily: '"Google Sans", sans-serif' }}>
        ...
        <div className="mt-12 text-center w-full">
          <p className="font-body-sm text-on-surface-variant">
            ...
            <Link href="/register" className="text-accent-orange font-bold hover:underline transition-all">Inscris-toi</Link>
          </p>
        </div>
      </main>
    </div>
