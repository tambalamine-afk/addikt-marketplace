    ...
    <div className="bg-surface-container-lowest text-primary min-h-[calc(100vh-200px)] flex flex-col justify-center items-center p-grid-gutter antialiased w-full">
      <main className="w-full max-w-sm flex flex-col items-center">
        ...
        <form className="w-full space-y-6" onSubmit={handleLogin}>
          ...
          {/* Google Button */}
          <Link href="/" className="w-full bg-surface-container-lowest border-2 border-outline-variant text-primary font-button-text py-5 rounded-full flex items-center justify-center space-x-3 hover:bg-surface-container-low active:scale-95 transition-all duration-200 font-semibold whitespace-nowrap" style={{ fontFamily: '"Google Sans", sans-serif' }}>
