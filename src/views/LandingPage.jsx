    ...
    <main>
      ...
      <section className={`w-full min-h-[500px] flex items-center justify-center relative overflow-hidden py-8 md:py-20 mx-auto max-w-full ${toggleState === 'acheter' ? 'bg-accent-orange' : 'bg-[#00a6fb]'}`}>
        <div className="max-w-7xl mx-auto w-full px-container-margin grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
          <div className="flex flex-col justify-center items-center text-center md:items-start md:text-left pt-0">
            ...
            {/* 4. Button */}
            {toggleState === 'acheter' ? (
              <Link href="/category/nouveautes" className="inline-block bg-primary text-white px-8 py-3.5 rounded-full font-bold text-[16px] hover:opacity-90 transition-opacity mb-8" style={{ fontFamily: '"Zalando Sans Expanded", sans-serif', fontWeight: 600 }}>
                Découvrir
              </Link>
            ) : (
      ...
      <section className="w-full max-w-7xl mx-auto px-container-margin py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Link href="/category/sneakers" className="bg-gray-100 rounded-[30px] overflow-hidden relative group block h-[400px] md:h-[520px]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href="/category" className="bg-[#A0704F] rounded-[30px] overflow-hidden relative group block h-[250px] md:h-[304px]">
            ...
            <div className="bg-[#00a6fb] rounded-[30px] p-6 flex flex-col justify-between group cursor-pointer h-[200px] relative overflow-hidden">
              ...
              <div className="flex justify-between items-end mt-4 relative z-10">
                ...
                <Link href="/register" className="w-12 h-12 bg-primary text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-md flex-shrink-0">
      ...
      <section className="w-full py-10 flex flex-col items-center justify-center overflow-hidden min-h-[500px] bg-surface">
        ...
        <div className="w-full max-w-7xl mx-auto px-container-margin relative z-10 mt-[-50px]">
          <svg className="w-full h-auto" viewBox="-100 -50 1490.71 460.67" xmlns="http://www.w3.org/2000/svg">
            ...
            <g>
              <g className="shape-group-1" transform="translate(100, 0)"><Link href="/category/femmes"><path className="cls-cat-16" d="M651.31,226.37c27.59-27.6,7.04-92.89-45.92-145.85-52.95-52.95-118.25-73.51-145.85-45.92-21.47,21.47-13.78,65.78,15.64,109.33-20.45-3.73-38.03-.5-49.31,10.77-27.59,27.59-7.04,92.89,45.92,145.85,52.95,52.95,118.25,73.51,145.85,45.92,21.47-21.47,13.78-65.78-15.64-109.33,20.45,3.73,38.03.51,49.31-10.77Z"></path></Link></g>
              <g className="shape-group-2" transform="translate(0, 0)"><Link href="/category/hommes"><path className="cls-cat-18" d="M402.49,149.22c-5.07-5.57-11.09-9.96-17.8-13.19-9.06-59.14-48.45-102.49-90.61-98.11-44.05,4.58-74.43,59.52-67.86,122.73,1.48,14.25,4.72,27.69,9.34,39.93-23.27,37.23-25.92,78.64-3.23,103.56,29.81,32.75,92.07,24.61,139.06-18.16,46.99-42.78,60.92-104,31.11-136.75Z"></path></Link></g>
              <g className="shape-group-3" transform="translate(150, 0)"><Link href="/category/enfants"><path className="cls-cat-14" d="M798.46,0c74.9-.31,99.3,108.8,32.32,141.46,24.75,35.96,26.68,84.46.64,120.28,25.74,191.51-267.7,69.29-148.23-66.65C609.1,102.36,695.94,2.43,798.46,0Z"></path></Link></g>
              <g className="shape-group-4" transform="translate(200, 0)"><Link href="/category/accessoires"><path className="cls-cat-15" d="M949.07,18.58c55.94.32,82.41,62.01,88.5,109.9,46.94,15.15,66.09,77.08,37.1,116.49-10.3,14.7-25.55,25.51-42.91,30.18-13.86,8.74-26.62,19.26-37.98,31.04-28.35,78.42-147.79,59.38-148.76-23.76-.86-46.13,30.24-85.09,39.65-129.12.5-24.16-23.71-33.33-13.51-76.66,8-34.74,42.21-60.75,77.9-58.06Z"></path></Link></g>
              <g className="shape-group-5" transform="translate(-100, 0)"><Link href="/category/femmes"><path className="cls-cat-17" d="M206.55,187.13c-24.11,83.01-87.83,150.31-142.31,150.31S-14.86,270.15,9.26,187.13C33.37,104.12,97.09,36.82,151.57,36.82s79.1,67.3,54.98,150.31Z"></path></Link></g>
              <g className="shape-group-6" transform="translate(250, 0)"><Link href="/category/accessoires"><path className="cls-cat-1" d="M1167.17,61.22l23.89,17.36,29.45-2.2c43.87-3.28,77.05,38.98,63.45,80.82l-9.13,28.09,11.19,27.33c16.67,40.71-13.27,85.32-57.26,85.32h-29.53s-22.53,19.09-22.53,19.09c-33.56,28.44-85.25,13.75-98.84-28.09l-9.13-28.09-25.12-15.53c-37.42-23.13-39.42-76.82-3.83-102.68l23.89-17.36,7.01-28.69c10.44-42.73,60.88-61.23,96.47-35.37Z"></path></Link></g>
            </g>
          </svg>
        </div>
      </section>
