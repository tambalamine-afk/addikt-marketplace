  ...
  return (
    <div className="bg-surface-container-lowest text-primary min-h-[calc(100vh-200px)] flex flex-col justify-center items-center p-grid-gutter antialiased w-full">
      <main className="w-full max-w-sm flex flex-col items-center">
        ...
        {/* Title */}
        <h1 className="font-headline-md text-2xl text-center uppercase tracking-tight mb-8">
        ...
        <form className="w-full space-y-6">
          ...
          <div className="flex items-center border-2 border-outline-variant focus-within:border-primary transition-colors bg-surface-container-lowest h-14">
            <span className="px-4 border-r-2 border-outline-variant font-label-caps text-secondary h-full flex items-center bg-surface-container-low">
              +221
            </span>
          ...
          {/* Submit Button */}
          <Link to="/verify" className="w-full bg-primary text-on-primary font-button-text py-5 rounded-full uppercase tracking-widest hover:opacity-80 active:scale-95 transition-all duration-200 block text-center">
            Continuer
          </Link>
          ...
          <div className="flex items-center py-4">
            ...
            <span className="px-4 font-label-caps text-secondary uppercase">ou</span>
            <hr className="flex-1 border-t-2 border-outline-variant" />
          </div>
          
          {/* Google Button */}
          <button className="w-full bg-surface-container-lowest border-2 border-outline-variant text-primary font-button-text py-5 rounded-full flex items-center justify-center space-x-3 hover:bg-surface-container-low active:scale-95 transition-all duration-200" type="button">
