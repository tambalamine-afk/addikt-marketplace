    ...
    <div className="bg-surface text-on-surface min-h-screen flex flex-col items-center justify-center p-4 antialiased">
      ...
      <main className="w-full max-w-md bg-white border-[3px] border-black p-6 md:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative z-10">
        ...
        <div className="mt-8 text-center">
          <Link to="/login" className="font-button-text text-button-text text-on-surface hover:text-accent-rose transition-colors underline decoration-2 decoration-black hover:decoration-accent-rose underline-offset-4" style={{ fontFamily: '"Google Sans", sans-serif' }}>
